...
void categoryFilter(String inOrOut, String category) {
    ...
    recordDesc2:
    `입금/출금 내역의 총 금액을 구하기 위하여 for문을 이용하여 각 행의 내역이 입금인지 출금인지 확인하여 줍니다. 만약 입금일 경우 총 sum이라는 변수에
    ...
    recordDesc3:
    `오른쪽 상단의 '상세' 버튼을 누르면 새로운 창이 나오며 입금과 출금의 toggle 버튼이 보이고 아래에는 각자에 해당하는 분류들이 적혀있는
    버튼이 나옵니다. 분류 버튼을 하나씩 눌러주면 그 분류를 category 변수에 저장시키고 categoryFilter() 메소드에 인자값으로 보내줍니다. category
